 ...
 */
class TestTokenWithGroupsPath2 {
    ...
    @Test
    void groupsObject() throws Exception {
    ...
    @Test
    void groupsString() throws Exception {
        JWTAuthContextInfo contextInfo = new JWTAuthContextInfo(publicKey, TEST_ISSUER);
        ...
        assertTrue(groups.contains("microprofile_jwt_user1"));
        assertTrue(groups.contains("microprofile_jwt_user2"));
    }
}
