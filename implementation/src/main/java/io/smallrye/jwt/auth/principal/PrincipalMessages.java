...
interface PrincipalMessages {
    ...
    @Message(id = 7012, value = "Verification key is unresolvable")
    ParseException verificationKeyUnresolvable();

    @Message(id = 7013, value = "Decryption key is unresolvable")
    ParseException decryptionKeyUnresolvable();

    @Message(id = 7014, value = "Encrypted token sequence is invalid")
